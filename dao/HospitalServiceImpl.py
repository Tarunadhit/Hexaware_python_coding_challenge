import pyodbc
from dao.IHospitalService import HospitalService
from entity.appointment import Appointment
from exception.patientException import PatientNumberNotFoundException
...
class HospitalServiceImpl(HospitalService):
    def execute_query(self, query, values=None):
        ...
        try:
            ...
            stmt.execute(query, values) # type: ignore
